      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
          ...
          <?php
			...
			{
			?>
			<a href="form/cart.php"><span style=" color:black; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:green;" id="cart"  class="badge badge-light"><?php if(isset($re)) { echo $re; }?></span></i></span></a>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <img class="d-block w-100" src="img/service.jpg" alt="Second slide">
	</div>
