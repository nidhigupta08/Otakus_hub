...
<div class="row">
   ...
   <?php
	  ...
	  tblvendor.fld_phone,tblvendor.fld_address,tblvendor.fld_logo,tbgood.goodname,tbgood.cost,
	  tbgood.categories,tbgood.paymentmode,tbgood.fldimage from tblvendor inner join
	  tbgood on tblvendor.fldvendor_id=tbgood.fldvendor_id where tbgood.good_id='$fid'");
	  if(mysqli_num_rows($query))
	  {
	  while($res=mysqli_fetch_assoc($query))
	  {
		   $shop_logo= "image/merchant/".$res['fld_email']."/".$res['fld_logo'];
		   $good_pic= "image/merchant/".$res['fld_email']."/goodimages/".$res['fldimage'];
	  ?>
	  <div class="container-fluid">
	  <div class="container-fluid">
	     <div class="row" style="padding-top:10px; ">
		      <div class="col-sm-2"><img src="<?php echo $shop_logo; ?>" class="rounded-circle" height="50px" width="50px" alt="Cinque Terre"></div>
		      <div class="col-sm-6">
	  ...
	  <div class="row" style="padding:10px;padding-top:0px;padding-right:0px; padding-left:0px;">
		 <div class="col-sm-12"><img src="<?php echo $good_pic; ?>" class="rounded" height="400px" width="100%" alt="Cinque Terre"></div>
	  ...
	  <div class="container-fluid">
		 ...
		 <div class="col-sm-5">
		 <span><li><?php echo $res['categories']; ?></li></span>
		 <span><li><?php echo "Rs ".$res['cost']; ?>&nbsp;for 1</li></span>
		 <span><li>Up To 3 days</li></span>
		 </div>
		 <div class="col-sm-6" style="">
		 <b><?php echo"(" .$res['goodname'].")"?></b>
		 </div>
		 </div>
