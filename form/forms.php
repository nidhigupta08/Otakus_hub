...
<div class="middle" style=" position:fixed; padding:40px; border:1px solid #00ffff; left:30%; top:30%; width:400px;">
	   ...
	   <!--login Section-- starts-->
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
			  <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="login" style="background:#000000; border:1px solid #00ffff;" class="btn btn-primary">Login In</button>
            ...
            <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
			    <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="register" style="background:#000000; border:1px solid #00ffff;" class="btn btn-primary">Create New Account</button>
                  <div class="footer" style="color:red;"><?php if(isset($ermsg)) { echo $ermsg; }?><?php if(isset($ermsg2)) { echo $ermsg2; }?></div>
			 </form>
			</div>
