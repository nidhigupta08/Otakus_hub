	...
	<div class="container">
		<div class="row" style="background-color: beige;">
				...
				<form method="post">
					...
					<div class="form-group">
						<input type="email" class="form-control" placeholder="email*"
							value="<?php if (isset($cust_id))
	                 echo $cust_id; ?>" name="email" required />
					</div>
					<div class="form-group">
			...
			<div class="col-sm-4" style="padding:30px;">
				<div class="form-group">
					<i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>9765875093/8805770660/8887637026</b><br><br>
					<i class="fa fa-home" aria-hidden="true"></i>&nbsp;Christ clg ,Pune-411001<br>(24*7 Days)
